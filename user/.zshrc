...
__conda_setup="$('/home/alvaro/enter/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/alvaro/enter/etc/profile.d/conda.sh" ]; then
        . "/home/alvaro/enter/etc/profile.d/conda.sh"
    else
        export PATH="/home/alvaro/enter/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
